...
from devop.views.deploy import deploy_add, deploy_list, deploy_ask, deploy_init,deploy_order,deploy_log,deploy_modf
from devop.views.cron import cron_log, cron_add, cron_list, cron_config, cron_mod
...
urlpatterns = [
    ...
    url(r'^cron_mod/(?P<cid>[0-9]+)/$', cron_mod),
    ...
    url(r'^api/permission/$', user_api.permission_list),
    url(r'^api/permission/(?P<id>[0-9]+)/$', user_api.permission_detail),
    ...
    url(r'^test/user/$', tests.getLoginUserInfo),
]
