...
from opman.tests import permission_required


@login_required()
#@permission_required('Project_Config.can_add_project_config', login_url='/noperm/')
@permission_required(next_url='/noperm/')
